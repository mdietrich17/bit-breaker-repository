...
namespace SimplySeniors.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            // The token generated by UserManager in ASP.NET Identity usually contains "+" 
            //characters which when passed as a query string get changed into ""(a space) in the URL.
            // Source: https://stackoverflow.com/questions/27241658/token-invalid-on-reset-password-with-asp-net-identity
